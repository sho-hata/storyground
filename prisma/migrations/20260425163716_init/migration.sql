...
-- CreateIndex
CREATE UNIQUE INDEX "Story_projectId_storyId_key" ON "Story"("projectId", "storyId");
...
-- AddForeignKey
ALTER TABLE "CommentThread" ADD CONSTRAINT "CommentThread_storyId_fkey" FOREIGN KEY ("storyId") REFERENCES "Story"("id") ON DELETE CASCADE ON UPDATE CASCADE;
