  ...
  <div style={{ minHeight: "100vh", background: "#f9fafb" }}>
    ...
    <div style={{ maxWidth: 1080, margin: "0 auto", padding: "24px 24px" }}>
      <Alert
        variant="info"
        title="v2.0 リリース準備中"
        message="全コンポーネントのレビューを今週中に完了してください。"
      />
              ...
              {s.change && (
                <span
                  style={{
                    fontSize: 13,
                    fontWeight: 600,
                    color: s.change.startsWith("+") ? "#16a34a" : "#dc2626",
                  }}
                >
                  {s.change}
                </span>
