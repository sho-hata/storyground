  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f9fafb" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 24px" }}>
        ...
        {/* Tabs */}
        <div
          style={{ display: "flex", gap: 0, borderBottom: "2px solid #e5e7eb", marginBottom: 32 }}
        >
          {tabs.map((tab) => (
            <button
              key={tab}
        ...
        {activeTab === "プロフィール" && (
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <Input
                label="メールアドレス"
                placeholder="senior-designer@example.com"
                type="email"
              />
        ...
        {activeTab === "通知" && (
          ...
          >
            ...
            <h2 style={{ fontSize: 16, fontWeight: 700, marginTop: 24, marginBottom: 16 }}>
              プッシュ通知
            </h2>
            ...
            {[
              {
                ...
                avatar: "https://i.pravatar.cc/150?u=taro",
              },
              {
                name: "田中花子",
                role: "編集者",
                email: "hanako@example.com",
                avatar: "https://i.pravatar.cc/150?u=hanako",
              },
              {
                name: "鈴木一郎",
                role: "編集者",
                email: "ichiro@example.com",
                avatar: "https://i.pravatar.cc/150?u=ichiro",
              },
              {
                name: "佐藤美咲",
                role: "閲覧者",
                email: "misaki@example.com",
                avatar: "https://i.pravatar.cc/150?u=misaki",
              },
            ].map((m) => (
              <div
                key={m.email}
